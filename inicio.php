                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            ...
                            <li><a class="text-decoration-none" href="#">Niño</a></li>
                    ...
                    <li class="pb-3">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">Tops</a></li>
                            <li><a class="text-decoration-none" href="#">Licras</a></li>
                            <li><a class="text-decoration-none" href="#">Vestidos</a></li>
                            <li><a class="text-decoration-none" href="#">Playeras</a></li>
                            <li><a class="text-decoration-none" href="#">Pantalon</a></li>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="assets/img/prototipo1.jpg">
